...
function App() {
  ...
  const [transactions, setTransactions] = useState<any[]>([]); // Updated type
  ...
  const fetchData = async () => {
    try {
      const thirdPartyRes = await axios.get('https://s3.amazonaws.com/roxiler.com/product_transaction.json');
      console.log(thirdPartyRes);
      const thirdPartyTransactions = thirdPartyRes.data;
      ...
      setTransactions([...transactionsRes.data.transactions, ...thirdPartyTransactions]);
